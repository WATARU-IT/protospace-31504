...
ActiveRecord::Schema.define(version: 2021_02_06_083931) do
  ...
  create_table "comment", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["prototype_id"], name: "index_comment_on_prototype_id"
  ...
  create_table "prototypes", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id"], name: "index_prototyps_on_user_id"
  end
  ...
  add_foreign_key "comment", "prototypes"
